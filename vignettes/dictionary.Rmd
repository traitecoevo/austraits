...
- allowable values:
    ...
    - *berry*: Maybe referring to the wings present on the pollen grains of some conifers to aid in their dispersal by wind
    - *bladdery_wings*: Bristle-like projections
    - *bristles*: REPLACE WITH 'bracts'
    ...
    - *bracts*: A type of eliasome, term especially used in the family Euphorbiaceae; an outgrowth or appendage at or near the hilum of certain seeds that aids in dispersal. Includes "strophiole"
    - *caruncle*: A curved, slender awn
    - *curved_awn*: Dry fruit that dehisces in some manner
    - *dry_dehiscent*: Fruit with membranous exocarp, fleshy mesocarp and hard endocarp
    - *drupe*: Fleshy (often fatty) appendage on seeds that attracts ants
    - *elaiosome*: Wing-line seed extentions that enclose the seed
    - *enclosing_wing*: A seed that lacks an aril
    - *exarillate*: When a feathery style aids in seed dispersal
    - *feathery_style*: A fleshy fruit that splits open and releases seeds at maturity; fruit type
    - *fleshy_dehiscent_capsule*: A fruit where part or all of the pericarp (fruit wall) is fleshy at maturity; fruit type
    - *fleshy_fruit*: A fruit whose capsule or wings are fleshy
    - *fleshy_wings_capsule*: Seed that is dispersed by floating on water
    - *floating_seed*: When a plant's floral parts, the petals and/or sepals, are persistent and aid in seed and fruit dispersal
    - *floral_parts*: The stalk that joins the seed to the pod frame; aids in dispersal when persistent
    - *funicle*: The modified membranous bracts surrounding the spikelet of a grass; also see 'bract'
    - *glumes*: Modified hairs aid in seed dispersal
    - *hairs*: Fruit that does not open at maturity in a pre-defined way, but instead relies on predation or decomposition to release the seeds;fruit type
    - *indehiscent*: When some part of the seed, fruit, or associated tissues is inflated, aiding in seed or fruit dispersal
    - *inflated_parts*: When a fruit and associated tissues lack any dispersal appendages; see also exarillate
    - *none*: unknown meaning; currently used only for "Brachyscome dentata"
    - *paddles*: The pappus is the modified calyx, the part of an individual floret, that surrounds the base of the corolla tube in flower heads of the plant family Asteraceae
    - *pappus*: Pappus that is deciduous
    - *pappus_deciduous*: Exact dispersal mechanism unclear; currently used only for "Crowea saligna" (maybe others now)
    - *placental_endocarp*: Fruit or seed that has plumes to help with dispersal
    - *plumose*: UNKNOWN
    - *pseudo-wing*: UNKNOWN
    ...
    - *strophiole_on_seed*: Cases where a taxon's style, stigma or carpel are persistent and aid in seed or fruit dispersal
    ...
    - *wings*: Referring to small wing-like seed extensions that aid in wind dispersal
    - *wings_small*: UNSURE; assume it refers to conifers, where woody bracts protect the seeds
...
- allowable values:
    ...
    - *mud_on_cars*: Dispersules with elaiosomes (specialised nutritious appendages) that make them attractive for capture, transport and use by ants or related insects; true dispersal syndrome
    - *myrmecochory*: water; e.g. floating/submerged in fresh/saltwater currents
    - *nautohydrochory*: water; diaspore is propelled by action of rain on plant structure/wetting by rain or dew
    - *ombrohydrochory*: methods originating from parent plant or diaspore
    - *parent_plant_or_diaspore*: animal; diaspore is carried intentionally
    - *synzoochory*: Mobile; Seeds are dispersed without assistance; true dispersal syndrome; same as barochory or passive; seeds drop to the ground close to or beneath the parent plant
    - *unassisted*: UNKNOWN
    - *undefined*: Seeds are dispersed by a vertebrate; true dispersal syndrome
    - *vertebrate*: Seeds dispersal depends in some way on water; should use hydrochory instead
    - *water*: Seeds are dispersed by wind; true dispersal syndrome; should use anemochory instead
    - *wind*: wetting by rain or dew; also called hygrochasy
    - *xerochasywater*: Dispersal syndrome where fruit is transported by attaching itself to something, usually an animal; true dispersal syndrome; will overlap with exozoochory; also called epizoochory
