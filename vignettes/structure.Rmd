...
<tbody>
  ...
  <tr>
   <td style="text-align:left;"> cleaned_name </td>
  ...
  <tr>
   ...
   <td style="text-align:left;"> Where it could be indentified, the `taxonID` of the cleaned_name for this taxon in the APC. </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td style="text-align:left;"> The status of alternative records with the name `cleaned_name` in the APC. </td>
  </tr>
  <tr>
