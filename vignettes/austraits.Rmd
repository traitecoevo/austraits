...
#>    <chr>         <chr>       <chr>                                             <chr>                <chr>                 
#>  1 Campbell_2006 01          Mummel Gulf National Park                         description          New England wet scler…
...
#>  4 Campbell_2006 01          Mummel Gulf National Park                         fire history         The fire at MGNP was …
#>  5 Campbell_2006 01          Mummel Gulf National Park                         georeference remarks <NA>                  
#>  6 Campbell_2006 01          Mummel Gulf National Park                         locality             Mummel Gulf National …
#>  7 Campbell_2006 02          Mummel Gulf National Park, Washpool National Park description          New England wet scler…
...
#> 10 Campbell_2006 02          Mummel Gulf National Park, Washpool National Park fire history         The study area had no…
#> # ℹ 190 more rows
#> 
#> $contexts
#> # A tibble: 232 × 7
...
#>  1 Kubiak_2009 time to flowering type    entity_context from resprouting    Time from fire to flowering… entity… 03       
...
#> $methods
#> # A tibble: 38 × 15
#>    dataset_id    trait_name      methods method_id description sampling_strategy source_primary_key source_primary_citat…¹
#>    <chr>         <chr>           <chr>   <chr>     <chr>       <chr>             <chr>              <chr>                 
#>  1 Campbell_2006 plant_growth_f… Vegeta… 01        Study inve… The area selecte… Campbell_2006      M. L. Campbell and P.…
#>  2 Campbell_2006 dispersers      Life h… 01        Study inve… The area selecte… Campbell_2006      M. L. Campbell and P.…
#>  3 Campbell_2006 seedbank_locat… Respon… 01        Study inve… The area selecte… Campbell_2006      M. L. Campbell and P.…
#>  4 Campbell_2006 bud_bank_locat… Respon… 01        Study inve… The area selecte… Campbell_2006      M. L. Campbell and P.…
#>  5 Campbell_2006 resprouting_ca… Respon… 01        Study inve… The area selecte… Campbell_2006      M. L. Campbell and P.…
#>  6 Campbell_2006 post_fire_recr… Respon… 01        Study inve… The area selecte… Campbell_2006      M. L. Campbell and P.…
#>  7 Cernusak_2006 stem_dark_resp… Stem C… 01        Measuremen… The stem CO2 eff… Cernusak_2006      L. A. Cernusak, L. B.…
#>  8 Cernusak_2006 leaf_photosynt… Photos… 01        Measuremen… The stem CO2 eff… Cernusak_2006      L. A. Cernusak, L. B.…
#>  9 Cernusak_2006 leaf_stomatal_… Photos… 01        Measuremen… The stem CO2 eff… Cernusak_2006      L. A. Cernusak, L. B.…
#> 10 Cernusak_2006 leaf_intercell… Photos… 01        Measuremen… The stem CO2 eff… Cernusak_2006      L. A. Cernusak, L. B.…
#> # ℹ 28 more rows
#> # ℹ abbreviated name: ¹​source_primary_citation
#> # ℹ 7 more variables: source_secondary_key <chr>, source_secondary_citation <chr>, source_original_dataset_key <chr>,
#> #   source_original_dataset_citation <chr>, data_collectors <chr>, assistants <chr>, dataset_curators <chr>
#> 
#> $excluded_data
#> # A tibble: 0 × 27
#> # ℹ 27 variables: error <chr>, dataset_id <chr>, taxon_name <chr>, observation_id <chr>, trait_name <chr>, value <chr>,
#> #   unit <chr>, entity_type <chr>, value_type <chr>, basis_of_value <chr>, replicates <chr>, basis_of_record <chr>,
#> #   life_stage <chr>, population_id <chr>, individual_id <chr>, repeat_measurements_id <chr>, temporal_context_id <chr>,
#> #   source_id <chr>, location_id <chr>, entity_context_id <chr>, plot_context_id <chr>, treatment_context_id <chr>,
#> #   collection_date <chr>, measurement_remarks <chr>, method_id <chr>, method_context_id <chr>, original_name <chr>
#> 
#> $taxonomic_updates
#> # A tibble: 35 × 7
#>    dataset_id     original_name  aligned_name taxonomic_resolution taxon_name aligned_name_taxon_id aligned_name_taxonom…¹
#>    <chr>          <chr>          <chr>        <chr>                <chr>      <chr>                 <chr>                 
#>  1 Nicholson_2017 Acacia -unide… Acacia sp. … genus                Acacia sp… <NA>                  <NA>                  
#>  2 Thomas_2017    Acacia bracty… Acacia brac… species              Acacia br… https://id.biodivers… accepted              
#>  3 Campbell_2006  Acacia ulicif… Acacia ulic… species              Acacia ul… https://id.biodivers… accepted              
#>  4 Nicholson_2017 Allocasuarina… Allocasuari… genus                Allocasua… <NA>                  <NA>                  
#>  5 Campbell_2006  Banksia spinu… Banksia spi… species              Banksia s… https://id.biodivers… accepted              
#>  6 Yang_2023      Burnettia      Burnettia    <NA>                 Burnettia  <NA>                  <NA>                  
#>  7 Yang_2023      Caladenia      Caladenia    <NA>                 Caladenia  <NA>                  <NA>                  
#>  8 Yang_2023      Corybas        Corybas      <NA>                 Corybas    <NA>                  <NA>                  
#>  9 Campbell_2006  Denhamia cele… Denhamia ce… species              Denhamia … https://id.biodivers… accepted              
#> 10 Campbell_2006  Dodonaea mega… Dodonaea me… species              Dodonaea … https://id.biodivers… accepted              
#> # ℹ 25 more rows
#> # ℹ abbreviated name: ¹​aligned_name_taxonomic_status
#> 
#> $taxa
#> # A tibble: 454 × 16
#>    taxon_name         taxon_rank taxonomic_status taxonomic_dataset taxon_name_alternati…¹ genus family binomial trinomial
#>    <chr>              <chr>      <chr>            <chr>             <chr>                  <chr> <chr>  <chr>    <chr>    
#>  1 Acacia acradenia   species    accepted         APC               Acacia umbellata (tax… Acac… Fabac… Acacia … <NA>     
#>  2 Acacia bivenosa    species    accepted         APC               <NA>                   Acac… Fabac… Acacia … <NA>     
#>  3 Acacia brachybotr… species    accepted         APC               <NA>                   Acac… Fabac… Acacia … <NA>     
#>  4 Acacia catenulata… subspecies accepted         APC               <NA>                   Acac… Fabac… Acacia … Acacia c…
#>  5 Acacia dealbata    species    accepted         APC               <NA>                   Acac… Fabac… Acacia … <NA>     
#>  6 Acacia falciformis species    accepted         APC               <NA>                   Acac… Fabac… Acacia … <NA>     
#>  7 Acacia irrorata    species    accepted         APC               <NA>                   Acac… Fabac… Acacia … <NA>     
#>  8 Acacia longifolia… subspecies accepted         APC               <NA>                   Acac… Fabac… Acacia … Acacia l…
#>  9 Acacia maidenii    species    accepted         APC               <NA>                   Acac… Fabac… Acacia … <NA>     
#> 10 Acacia maitlandii  species    accepted         APC               <NA>                   Acac… Fabac… Acacia … <NA>     
#> # ℹ 444 more rows
#> # ℹ abbreviated name: ¹​taxon_name_alternatives
#> # ℹ 7 more variables: taxon_distribution <chr>, establishment_means <chr>, scientific_name <chr>, taxon_id <chr>,
#> #   taxon_id_genus <chr>, taxon_id_family <chr>, scientific_name_id <chr>
#> 
#> $contributors
#> # A tibble: 15 × 6
...
#>  2 Campbell_2006  Clarke    Peter      <NA>                University of New England, Australia            <NA>           
#>  3 Cernusak_2006  Cernusak  Lucas      0000-0002-7575-5526 College of Science and Engineering, James Cook… contact        
#>  4 Kubiak_2009    Kubiak    P. J.      <NA>                <NA>                                            <NA>           
#>  5 Nicholson_2017 Nicholson Áine       <NA>                University of Tasmania, Australia               <NA>           
#>  6 Nicholson_2017 Prior     Lynda      0000-0002-5511-2320 University of Tasmania, Australia               contact        
#>  7 Nicholson_2017 Bowman    David      0000-0001-8075-124X University of Tasmania, Australia               <NA>           
#>  8 Prior_2022     Prior     Lynda      0000-0002-5511-2320 University of Tasmania, Australia               <NA>           
#>  9 Prior_2022     Wood      Sam        <NA>                University of Tasmania, Australia               contact        
#> 10 Thomas_2017    Thomas    Freya      0000-0001-9926-6295 University of Melbourne, Australia              contact        
#> 11 Thomas_2017    Vesk      Peter      0000-0003-2008-7062 University of Melbourne, Australia              <NA>           
#> 12 Yang_2023      Yang      Sophie     0000-0001-7328-345X Evolution & Ecology Research Centre, School of… contact        
#> 13 Yang_2023      Wenk      Elizabeth  0000-0001-5640-5910 Evolution & Ecology Research Centre, School of… <NA>           
#> 14 Yang_2023      Coleman   David      0000-0002-1773-6597 Evolution & Ecology Research Centre, School of… <NA>           
#> 15 Purdie_1976    Purdie    Rosemary   <NA>                unknown                                         <NA>           
#> 
#> $sources
#> [1] M. L. Campbell and P. J. Clarke. "Response of montane wet sclerophyll forest understorey species to
#> fire- evidence from high and low intensity fires". In: _Proceedings of the Linnean Society of New South
#> Wales_ 127 (2006), pp. 63-73. DOI: unknown.
#> 
#> [2] L. A. Cernusak, L. B. Hutley, J. Beringer, et al. "Stem and leaf gas exchange and their responses to
#> fire in a north Australian tropical savanna". In: _Plant, Cell and Environment_ 29.4 (2006), pp. 632-646.
#> DOI: 10.1111/j.1365-3040.2005.01442.x.
#> 
#> [3] P. J. Kubiak. "Fire responses of bushland plants after the January 1994 wildfires in northern Sydney".
#> In: _Cunninghamia_ 11.1 (2009), pp. 131-165.
#> 
#> [4] A. Nicholson, L. D. Prior, G. L. W. Perry, et al. "High post-fire mortality of resprouting woody plants
#> in Tasmanian Mediterranean-type vegetation". In: _International Journal of Wildland Fire_ 26 (2017), pp.
#> 532-537. DOI: http://dx.doi.org/10.1071/WF16211.
#> 
#> [5] L. D. Prior, S. M. Foyster, J. M. Furlaud, et al. "Using permanent forest plots to evaluate the
#> resilience to fire of Tasmania's tall wet eucalypt forests". In: _Forest Ecology and Management_ 505 (2022),
#> p. 119922. DOI: 10.1016/j.foreco.2021.119922.
#> 
#> [6] R. W. Purdie and R. O. Slatyer. "Vegetation succession after fire in sclerophyll woodland communities in
#> south-eastern Australia". In: _Australian Journal of Ecology_ 1 (1976), pp. 223-236.
#> 
#> [7] F. M. Thomas and P. A. Vesk. "Are trait-growth models transferable? Predicting multi-species growth
#> trajectories between ecosystems using plant functional traits". In: _PLOS ONE_ 12.5 (2017), p. e0176959.
#> DOI: 10.1371/journal.pone.0176959.
#> 
#> [8] F. M. Thomas and P. A. Vesk. "Growth races in The Mallee: Height growth in woody plants examined with a
#> trait-based model". In: _Austral Ecology_ 42.7 (2017), pp. 790-800. DOI: 10.1111/aec.12501.
#> 
#> [9] S. Yang. "Unpublished data: Fire response traits scored from national and state floras and the taxonomic
#> literature, University of New South Wales". 2023.
#> 
#> $definitions
...
#> [1] "https://linked.data.gov.au/def/anzsrc-for/2020/3103"   "https://linked.data.gov.au/def/anzsrc-for/2020/3104"  
#> [3] "https://linked.data.gov.au/def/anzsrc-for/2020/4104"   "https://linked.data.gov.au/def/anzsrc-for/2020/300703"
#> [5] "https://linked.data.gov.au/def/anzsrc-for/2020/060705" "https://linked.data.gov.au/def/anzsrc-for/2020/050202"
#> [7] "https://linked.data.gov.au/def/anzsrc-for/2020/060208" "https://linked.data.gov.au/def/anzsrc-for/2020/069902"
#> 
#> 
