...
test_that("functions should work without warnings", {
  expect_silent(join_locations(austraits_5.0.0_lite))
  expect_silent(join_methods(austraits_5.0.0_lite))
  expect_silent(join_contexts(austraits_5.0.0_lite))
  expect_silent(join_taxonomy(austraits_5.0.0_lite))
  expect_silent(join_all(austraits_5.0.0_lite))
})

test_that("structure doesn't change", {
  expect_type(join_locations(austraits_5.0.0_lite), "list")
  expect_type(join_methods(austraits_5.0.0_lite), "list")
  expect_type((join_contexts(austraits_5.0.0_lite)), "list")
  expect_type(join_taxonomy(austraits_5.0.0_lite), "list")
  expect_type((join_all(austraits_5.0.0_lite)), "list")
})
